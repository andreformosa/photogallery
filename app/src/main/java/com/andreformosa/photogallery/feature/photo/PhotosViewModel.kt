...
import com.andreformosa.photogallery.data.model.remote.Photo as PhotoResponse
...
class PhotosViewModel @Inject constructor(
    ...
    val photos: StateFlow<List<Photo>> = flow {
        val items = JsonParser().fromJson<List<PhotoResponse>>(json).map { it.asPhotoEntity() }
        emit(items)
